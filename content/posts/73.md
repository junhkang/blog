...
![](/images/posts/73/스크린샷%202024-03-18%20오후%204.10.50.png)
...
### 2-1. Display 클래스 {#display-클래스 ke-size="size23"}
...
### 2-3. Border 클래스 {#border-클래스 ke-size="size23"}
...
### 2-5. FullBorder 클래스 {#fullborder-클래스 ke-size="size23"}
