...
teaching:
  - title: "AI·SW마에스트로 17기 – 멘토 (2026)"
  - title: "DN솔루션즈 뉴런세미나 – 질문하는 AI에서 일하는 AI로: 실무자를 위한 AI 활용 (2026/08)"
  - title: "공공기관 – 프롬프트 엔지니어링부터 리서치 자동화까지 (2025/11)"
    details: "LLM 기반 리서치 혁신: 프롬프트, 데이터 수집·정제, RAG, 보고서 자동화, 보안·컴플라이언스"
  - title: "PostgreSQL 벡터DB 구축과 인덱스 최적화 전략 – AI 시대의 PostgreSQL: 데이터 허브에서 벡터DB로 (2025/10)"
    details: "pgvector 임베딩 저장·검색, HNSW/IVF 인덱싱, 통계/플랜 최적화, RAG 혼합 검색 아키텍처"
  - title: "2025 Build with AI for Everyone – AI를 현업 서비스에 넣기까지: 기술 쇼케이스를 넘어 비즈니스 도구로 (2025/08)"
    details: "데모 단계 AI를 실서비스로 확장: 전략·운영 사례 (GDG Golang Korea, GDGoC Sogang)"
  - title: "한화 시스템 – 데이터를 움직이는 힘: 데이터 거버넌스 & 엔지니어링 실전"
    details: "거버넌스 ↔ 엔지니어링 워크플로 정렬, Airflow/Glue/Athena 실습"
  - title: "네이버 커넥트 & 모두의연구소 – Generative AI 2025 코딩 코치"
    details: "실제 적용 사례 중심 프로젝트 코칭"
  - title: "카카오 x 구름 – Deep Dive 백엔드 개발자 세미나"
    details: "매력적인 포트폴리오 구성, 백엔드 모범 사례"
  - title: "모두의연구소 – 연세대 DX 코딩캠프 (데이터 분석 심화 과정)"
    details: "산업 현장 분석 기법·도구, 메인 코치"
  - title: "카카오 x 구름 – Deep Dive 백엔드 개발자 워크숍"
    details: "이슈 트래킹, 협업 도구, 생산성 향상"
  - title: "순천향대학교 – 초기창업패키지 기술강연"
    details: "LLM, DB 최적화, AWS로 스타트업 확장"
